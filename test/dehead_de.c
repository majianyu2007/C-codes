...
int main(int argc, char *argv[]) {
    ...
    if (((((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x7f) == 0)) {
        int exit_code = ((((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0xff00) >> 8);
        if (exit_code != 0) {
        ...
        fprintf(stderr, "Error: preprocessor '%s' killed by signal %d\n",
                cc, (((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x7f));
        goto cleanup;
    }
